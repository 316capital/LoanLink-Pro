...
export default function About() {
  return (
    <div className="min-h-screen bg-navy-950 pt-32 pb-20">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mb-20">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tighter uppercase leading-[0.9]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {[
            ...
            <Card key={idx} className="bg-navy-900 border border-white/5 shadow-xl hover:shadow-2xl transition-all duration-300 rounded-none overflow-hidden group">
              <CardContent className="p-8">
                <div className="mb-6 group-hover:scale-110 transition-transform duration-300">{value.icon}</div>
                <h3 className="text-lg font-bold text-white mb-3 tracking-wider">{value.title}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl font-bold text-white mb-8 tracking-tighter uppercase italic border-l-4 border-gold-500 pl-6">The 316 Standard</h2>
            <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
              ...
              <div className="pt-8 border-t border-white/10">
                <p className="text-gold-500 font-bold uppercase tracking-widest text-sm">Deployment Philosophy</p>
                <p className="text-2xl font-serif italic text-slate-200 mt-2">"We don't just fund deals; we empower the transformation of the built environment through intelligent capital."</p>
              </div>
            </div>
          </div>
        </div>
