...
import { CheckCircle2, ArrowRight, Hammer, Zap, Clock } from "lucide-react";
      ...
      <section className="py-12 bg-cream-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { label: "Interest Rates", value: "7.90%+" },
              { label: "LTC (Purchase)", value: "90%" },
              { label: "Rehab Funding", value: "100%" },
              { label: "Draw Speed", value: "24 Hours" }
            ].map((stat, i) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            <div>
              <h2 className="text-3xl font-bold text-navy-950 uppercase mb-8 tracking-tight">The Capital You Need to Win Deals</h2>
              <div className="space-y-6 text-gray-600 leading-relaxed font-medium">
                <p>
                  In the fix and flip business, speed is the only metric that matters. Our bridge capital program is built on AI-driven underwriting that allows us to move from application to closing in as little as 7 days, with rehab draws funded within 24 hours of inspection.
                </p>
                <div className="space-y-4 pt-4">
                  {[
                    "Up to 90% Purchase Price Funding",
                    "100% Rehab Budget Funding",
                    "No experience required options",
                    "Non-Dutch interest available",
                    "Appraisal-free options in select markets"
                  ].map((item, i) => (
            ...
            <Card className="rounded-none border-navy-950/10 shadow-2xl bg-navy-950 text-white p-10 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold uppercase mb-8 relative z-10">Capital Parameters</h3>
              <div className="space-y-6 relative z-10">
                {[
                  { label: "Max LTC", value: "90% Purchase / 100% Rehab" },
                  { label: "Max ARV LTV", value: "75%" },
                  { label: "Loan Terms", value: "12 - 18 Months" },
