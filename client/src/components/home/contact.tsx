...
export function Contact() {
  return (
    <section id="contact" className="py-24 bg-[#001A54] relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-[#F2C100]/5 blur-[120px] rounded-full -mr-20 -mt-20" />
      <div className="absolute bottom-0 left-0 w-1/4 h-1/4 bg-[#F2C100]/5 blur-[100px] rounded-full -ml-20 -mb-20" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            >
              <h2 className="text-sm font-bold text-[#F2C100] uppercase tracking-[0.3em] mb-4">Initialize Contact</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6 group">
                  <div className="h-12 w-12 rounded-none border border-white/10 flex items-center justify-center bg-white/5 group-hover:border-[#F2C100]/50 transition-colors">
                    <Phone className="h-5 w-5 text-[#F2C100]" />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Direct Line</p>
                    <a href="tel:+16175464817" className="text-xl font-bold text-white hover:text-[#F2C100] transition-colors">+1 (617) 546-4817</a>
                  </div>
                </div>

                <div className="flex items-start space-x-6 group">
                  <div className="h-12 w-12 rounded-none border border-white/10 flex items-center justify-center bg-white/5 group-hover:border-[#F2C100]/50 transition-colors">
                    <Mail className="h-5 w-5 text-[#F2C100]" />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Email Correspondence</p>
                    <a href="mailto:info@316cap.com" className="text-xl font-bold text-white hover:text-[#F2C100] transition-colors">info@316cap.com</a>
                  </div>
                </div>

                <div className="flex items-start space-x-6 group">
                  <div className="h-12 w-12 rounded-none border border-white/10 flex items-center justify-center bg-white/5 group-hover:border-[#F2C100]/50 transition-colors">
                    <MapPin className="h-5 w-5 text-[#F2C100]" />
                  </div>
                  <div>
