...
import heroBg from "@assets/generated_images/realistic_construction_aerial.png";
  ...
  return (
    <div className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pb-32">
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#001A54]/60 via-[#001A54]/40 to-[#001A54]/70 mix-blend-multiply" />
