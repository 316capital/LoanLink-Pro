        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <div className="block mb-6 cursor-pointer">
                <img src={logoWhite} alt="316 Capital Logo" className="h-48 md:h-64 lg:h-80 w-auto object-contain" />
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              ...
              <li><a href="/assets/documents/316-Partner-Playbook.pdf" download="316-Partner-Playbook.pdf" className="hover:text-gold-500 transition-colors">Partner Playbook</a></li>
