        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8 lg:space-x-12">
              ...
              <a href="/#products" className="text-sm font-semibold text-[#001A54] hover:text-[#F2C100] transition-colors uppercase tracking-wider">Loan Products</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-cream-50 border-b border-navy-950/5">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="/#products" className="block px-3 py-2 text-base font-medium text-[#001A54] hover:bg-white/50">Loan Products</a>
